...
const store = new Vuex.Store({
    ...
    mutations: {
        ...
        updateStatus: (state, data) => {
            state.tasks[data.index].isComplete = data.value
        },
        ...
        updateTotalMoney(state){
            ...
            for (let i = 0 ; i < carts.length;i++){
                state.total += state.carts[i].qty * state.carts[i].price
            }
        },
        changeCart(state,value){
            state.carts.splice(value, 1);
        },
        deleteProductInCart(state,value){
            state.carts.splice(value, 1);
        },
        ...
        updateNameErrorMsg: (state, value) => {
            state.nameErrorMsg = value
        },
        updatePriceErrorMsg: (state, value) => {
            state.priceErrorMsg = value
        },
        updateQuantityErrorMsg: (state, value) => {
            state.quantityErrorMsg = value
        },
        updateButton: (state, value) => {
